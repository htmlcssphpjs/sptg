...
def get_text_messages(message):
    if message.text == "/help":
        bot.send_message(message.from_user.id, "Что не понятно? Пришешь мне сообщение и ждёшь ответа! <a href='https://zen.yandex.ru/media/vsevolodhtml/bot-dlia-obratnoi-sviazi-5f58fe6eefb9584a823adfd8'>Пост обо мне</a>", parse_mode='html')
